...
], function (SuperClass, Node, Utils, languageDependency, measurementSystemDependency) {
    ...
    */
    ...
    p.init = function () {
        ...
        if (brease.config.editMode) {
            this.executeWorkAroundEditorBars();
        }
    };
    ...
    p.executeWorkAroundEditorBars = function () {
        ...
        $(temporalDiv).children().children().insertAfter(this.elem.previousSibling);
        this.el.remove();
    ...
    function _sendDataChange(widget) { 
        ...
        if (widget.getAvoidSubmitChange()) { return; }
